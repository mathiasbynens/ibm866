...
// src/ibm866.src.mjs → ibm866.mjs
const LIB_TEMPLATE = fs.readFileSync('./src/ibm866.src.mjs', 'utf8');
const createLib = template(LIB_TEMPLATE, TEMPLATE_OPTIONS);
const libCode = createLib(require('./export-data.js'));
fs.writeFileSync('./ibm866.mjs', libCode);

// src/ibm866.d.ts → ibm866.d.ts
const TYPES_TEMPLATE = fs.readFileSync('./src/ibm866.d.ts', 'utf8');
const createTypes = template(TYPES_TEMPLATE, TEMPLATE_OPTIONS);
const typesCode = createTypes(require('./export-data.js'));
fs.writeFileSync('./ibm866.d.ts', typesCode);
